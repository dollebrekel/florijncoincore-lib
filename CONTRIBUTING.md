...
```sh
git remote add Ecrypty git@github.com:Ecrypty/florijncoincore-lib.git
git pull --rebase Ecrypty master
```
...
```
Finally go to [github.com/Ecrypty/florijncoincore-lib](https://github.com/Ecrypty/florijncoincore-lib) in your web browser and issue a new pull request.
...
[github.com/Ecrypty/florijncoincore-lib/issues](https://github.com/Ecrypty/florijncoincore-lib/issues).
