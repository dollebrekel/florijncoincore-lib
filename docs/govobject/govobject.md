...
A Governance Object (or "govObject") is a generic structure introduced in Florijncoin Core v12.1 to allow for the creation of Budget Proposals, Triggers, and Watch Dogs. Class inheritance has been utilized to extend this generic object into a "Proposal" which is outlined throughout the remainder of this document. 
...
####  `checkedSerialize`
Return a hex string that can be used in florijncoind CLI
####  `serialize`
Return a hex string
####  `inspect`
...
var jsonProposal = {
  ...
  payment_amount: 10,
  type: 1,
  url: "http://www.florijncoin.org/proposal/first_proposal"
};
...
```javascript
proposal.url = "http://florijncoin.org/badUrl"
var shallowCopyProposal = proposal.shallowCopy();
proposal.url = "http://florijncoin.org/fixedUrl"
