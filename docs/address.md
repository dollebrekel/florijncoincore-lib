# Florijncoin Address
Represents a Florijncoin address. Addresses are the most popular way to make Florijncoin transactions. See [the Florijncoin documentation](https://florijncoin-docs.github.io/en/glossary/address) for technical background information.
...
The errors are listed in the generated file in the [errors folder](https://github.com/dolledev/bitcore-florijncoin/tree/master/lib/errors). There's a structure to errors defined in the [spec.js file](https://github.com/dolledev/bitcore-florijncoin/tree/master/lib/errors/spec.js).
