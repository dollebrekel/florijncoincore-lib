...
For detailed technical information about a block please visit [Blocks](https://florijncoin-docs.github.io/en/glossary/block) on the Florijncoin Wiki.
...
For more information about the specific properties of a block header please visit the [Block headers](https://florijncoin-docs.github.io/en/developer-reference#block-headers) page on the Florijncoin Developer Reference Wiki.
