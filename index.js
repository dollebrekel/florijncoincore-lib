...
bitcore.versionGuard = function(version) {
  if (version !== undefined) {
    var message = 'More than one instance of florijncoincore-lib found. ' +
      'Please make sure that you are not mixing instances of classes of the different versions of florijncoincore.';
    console.warn(message);
  }
};
bitcore.versionGuard(global._florijncoincore);
global._florijncoincore = bitcore.version;
